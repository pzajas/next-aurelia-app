    ...
    >
      <div className="relative">
        ...
        <div className="mx-auto mt-4 flex max-w-md flex-col items-center text-center md:mt-5">
          <p className="text-[10px] font-sans uppercase leading-relaxed tracking-[0.42em] text-white/34">
          ...
          <div
            ...
            aria-hidden
          />
          <div className="mt-10 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-[10px] font-sans uppercase tracking-[0.38em] text-white/38 md:mt-12">
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 text-[10px] font-sans uppercase tracking-[0.28em] text-white/28 md:mt-8 md:grid-cols-[1fr_auto_1fr] md:items-center md:gap-x-8">
      ...
      <button
        type="button"
        onClick={scrollToTop}
        className="mt-10 flex w-full cursor-pointer items-center justify-center gap-2 text-[10px] font-sans uppercase tracking-[0.38em] text-white/28 transition-colors duration-500 hover:text-white/55 md:hidden"
      >
