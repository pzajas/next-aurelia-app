...
import FounderMobile from "@/components/sections/FounderMobile";
...
export default function Founder() {
  ...
  useEffect(() => {
    if (sectionEntered) setImageEntered(true);
  }, [sectionEntered]);
    ...
    >
      ...
      <div className="absolute inset-0 hidden md:block">
        <FounderPortraitStage
          activeKey={teamNames[active].image}
          imageSrc={teamNames[active].image}
          imageAlt={member.name}
          revealClip={revealClip}
          imageParallaxY={imageParallaxY}
          entered={imageEntered}
          ...
          quality={82}
          imageClassName="!object-[65%_35%]"
        />
      </div>

      <FounderMobile paused={paused} onPauseChange={setPaused} />
